...
insert into skill_steps (curriculum_version_id,stroke_id,track_id,key,label,ladder_order,is_first_completion,measure_spec,step_kind) select (select id from curriculum_versions where label='v1 - 2026 기본'), (select id from strokes where key='beginner'), (select id from skill_tracks where key='water' and stroke_id=(select id from strokes where key='beginner')), 'beginner.water.10','앞구르기',10,false, array[]::text[],'single';
insert into skill_steps (curriculum_version_id,stroke_id,track_id,key,label,ladder_order,is_first_completion,measure_spec,step_kind) select (select id from curriculum_versions where label='v1 - 2026 기본'), (select id from strokes where key='beginner'), (select id from skill_tracks where key='water' and stroke_id=(select id from strokes where key='beginner')), 'beginner.water.11','옆구르기',11,false, array[]::text[],'single';
insert into skill_steps (curriculum_version_id,stroke_id,track_id,key,label,ladder_order,is_first_completion,measure_spec,step_kind) select (select id from curriculum_versions where label='v1 - 2026 기본'), (select id from strokes where key='beginner'), (select id from skill_tracks where key='water' and stroke_id=(select id from strokes where key='beginner')), 'beginner.water.12','뒷구르기',12,false, array[]::text[],'single';
insert into skill_steps (curriculum_version_id,stroke_id,track_id,key,label,ladder_order,is_first_completion,measure_spec,step_kind) select (select id from curriculum_versions where label='v1 - 2026 기본'), (select id from strokes where key='beginner'), (select id from skill_tracks where key='water' and stroke_id=(select id from strokes where key='beginner')), 'beginner.water.13','물구나무 서기',13,false, array[]::text[],'single';
insert into skill_steps (curriculum_version_id,stroke_id,track_id,key,label,ladder_order,is_first_completion,measure_spec,step_kind) select (select id from curriculum_versions where label='v1 - 2026 기본'), (select id from strokes where key='beginner'), (select id from skill_tracks where key='water' and stroke_id=(select id from strokes where key='beginner')), 'beginner.water.14','물대포',14,false, array[]::text[],'single';
